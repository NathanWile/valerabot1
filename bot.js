...
client.on("guildMemberAdd", member => {
  member.roles.add('800680428322422824'); // UNREGİSTER ROLÜNÜN İDSİNİ GİRİN
});
...
client.on("guildMemberAdd", member => {  
  ...
  if (kurulus > 1296000000) kontrol = '✅'
  moment.locale("tr");
  kanal.send(":tada: Sunucumuza Hoş Geldin ! <@" + member + "> \n\n Hesabın "+ gecen +" Önce Oluşturulmuş "+kontrol+" \n\n Sunucu kurallarımız <#801386413614301244> kanalında belirtilmiştir. Unutma sunucu içerisinde ki ceza işlemlerin kuralları okuduğunu varsayarak gerçekleştirilecek. \n\n Seninle beraber " + member.guild.memberCount + " kişi olduk ! Tagımızı alarak bizlere destek olabilirsin ! Kayıt olmak için teyit odalarına girip ses teyit vermen gerekiyor <@&801089058218442782> seninle ilgilenecektir ! İyi eğlenceler.")
  });
...
client.on("guildMemberAdd", member => {
    ...
    const kytsz = member.guild.roles.cache.find(r => r.id === "800680428322422824") 
     var rol = member.guild.roles.cache.get("801089056419086367") // ŞÜPHELİ HESAP ROLÜNÜN İDSİNİ GİRİN
...
client.on("userUpdate", async (stg, yeni) => {
  ...
  var ekipTag = "𐊚"; // Buraya Ekip Tag
  var ekipRolü = "801127406789197854"; // Buraya Ekip Rolünün ID
  var logKanali = "800680908259852289"; // Loglanacağı Kanalın ID
...
client.on("guildMemberAdd", member => {
  ...
  let rol = "801127406789197854"; //Buraya tag alındığı zaman verilecek rolün IDsini yazın
